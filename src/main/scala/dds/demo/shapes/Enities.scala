...
class Entities(psub: String, ppub: String) {
  ...
  lazy val circle = Topic[ShapeType](defaultDomainParticipant, "Circle", "ShapeType")
  lazy val square = Topic[ShapeType](defaultDomainParticipant,"Square", "ShapeType")
  lazy val triangle = Topic[ShapeType](defaultDomainParticipant,"Triangle", "ShapeType")
