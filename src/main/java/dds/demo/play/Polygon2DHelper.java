...
/**
* dds/demo/play/Polygon2DHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ../idl/ddsplay.idl
* Monday, January 12, 2015 5:31:22 PM CET
*/

abstract public class Polygon2DHelper
{
  private static String  _id = "IDL:dds/demo/play/Polygon2D:1.0";

  public static void insert (org.omg.CORBA.Any a, dds.demo.play.Polygon2D that)
  {
  ...
  public static dds.demo.play.Polygon2D extract (org.omg.CORBA.Any a)
  {
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[3] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (dds.demo.play.Polygon2DHelper.id (), "Polygon2D", _members0);
          __active = false;
        }
      }
    }
  ...
  public static dds.demo.play.Polygon2D read (org.omg.CORBA.portable.InputStream istream)
  {
    dds.demo.play.Polygon2D value = new dds.demo.play.Polygon2D ();
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, dds.demo.play.Polygon2D value)
  {
