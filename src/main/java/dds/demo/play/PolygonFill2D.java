...
/**
* dds/demo/play/PolygonFill2D.java .
...
@KeyList(
    topicType = "PolygonFill2D",
    keys = {"sid", "id"}
)
public final class PolygonFill2D implements org.omg.CORBA.portable.IDLEntity
{
  ...
  public PolygonFill2D (int _sid, int _id, dds.demo.play.Coord2D[] _coordList, dds.demo.play.ColorRGB _borderColor)
  {
    sid = _sid;
    id = _id;
